<template>
	...
	<ui-row>
		<ui-col :span="24">
			<ui-checkbox-group v-model="checkbox">
	...
	<ui-row>
		<ui-col :span="24">
           <ui-select placeholder="请输入内容" v-model="value" @change="showVal" multiple remote>
	 ...
	 export default{
	   data () {
	     return {
	     	...
	     	checkbox:[],
	     	value:'',
	     	options:[{label:"北京",value:"1",disabled:true},{label:"上海",value:"2"},{label:"广州",value:"3"},{label:"深圳",value:"4"},{label:"长沙",value:"5"}],
	     	groupOptions:[

	     	{label:"热门城市",options:[{label:"北京",value:"1",disabled:true},{label:"上海",value:"2"},{label:"广州",value:"3"},{label:"深圳",value:"4"},{label:"长沙",value:"5"}]},
